...
#'
#' `bootstrapCI()` performs percentile bootstrap resampling to estimate confidence 
...
#'
#' @example
#' # Example usage of bootstrapCI
#' result_par <- bootstrapCI(iterations = 100,
#'                                   iptw = iptw_re, 
#'                                   data = data, 
#'                                   model = "SL", 
#'                                   cores = 4, 
...
#'                                   effect_type = "PNIE")
#'
bootstrapCI <- function(iterations = 50, iptw, data, model = "SL", cores = 2, core_seeds = NULL, effect_type = "PNIE") {

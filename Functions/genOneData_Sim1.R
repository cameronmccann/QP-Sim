...
# Data Generation 
#' 
#' `genOneData_Sim1()` generates clustered data consisting of a level-1 treatment,     <-- NEED TO UPDATE 
...
#' cluster ID (school); level-1 covariate (x); level-2 covariate (z); {{(t_ast)}}; 
